...
public class MavenProjectInput
{
    ...
    public ProjectsInputInfoType calculateChecksum( HashFactory hashFactory, Model toHash ) throws IOException
    {
        long time = Clock.time();

        final String effectivePom = getEffectivePom( toHash );
    ...
    private String getEffectivePom( Model toHash ) throws IOException
    {
