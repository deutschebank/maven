...
public interface MavenProjectHelper
{
    ...
    /**
     * Add or replace lazy artifact to the current project.
     * @param project the project reference.
     * @param artifactType the type (e.g. jar) or null.
     * @param artifactClassifier the classifier or null.
     * @param artifactFuture the file for the artifact.
     */
    void attachArtifact( MavenProject project, String artifactType, String artifactClassifier, Future<File> artifactFuture );
